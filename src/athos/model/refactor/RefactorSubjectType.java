...
public class RefactorSubjectType {
  /** Refactor on class. */
  public static final RefactorSubjectType CLASS = new RefactorSubjectType("CLASS"); 
  /** Refactor on method. */
  public static final RefactorSubjectType METHOD = new RefactorSubjectType("METHOD");
  /** Refactor on field. */
...
public static final RefactorSubjectType PACKAGE = new RefactorSubjectType("PACKAGE");
  ...
  public static RefactorSubjectType getInstance(String type) {
    ...
    return (RefactorSubjectType) RefactorSubjectType.subjects.get(upperType);
  }
