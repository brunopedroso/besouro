...
public class TestEpisodesFactory {
	  ...
	  public static void addTDDType1Facts(BesouroEpisodeClassification engine, Date clock) throws Exception {
	    // Add test method
...
//	    unitTestAction.assertJessFact(7, engine);
	  ...
	  public static void addTDDType2Facts(BesouroEpisodeClassification engine, Date clock) throws Exception {
	    // Add test method
	    RefactoringAction unaryAction = new RefactoringAction(clock, testFile);
	    unaryAction.setOperator("ADD");
	    unaryAction.setSubjectType("METHOD");
...
//	    unitTestAction.assertJessFact(5, engine);
	  ...
	  public static void addTDDType3Facts(BesouroEpisodeClassification engine, Date clock) throws Exception {
	    // Add test method
	    RefactoringAction unaryAction = new RefactoringAction(clock, testFile);
	    unaryAction.setOperator("ADD");
	    unaryAction.setSubjectType("METHOD");
...
//	    editAction.setDuration(123);
	  ...
	  public static void addTestCodeRefactoFacts(BesouroEpisodeClassification engine, Date clock) throws Exception {
...
//	    action.assertJessFact(2, engine); //TODO [rule] index 2 again ??!!
	  ...
	  public static void addProductionCodeRefactoFacts(BesouroEpisodeClassification engine, Date clock) throws Exception {
