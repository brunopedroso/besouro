...
You can simply download the files, you can perform a clone it with git, if you want to modify it, 
...
due to it's not open-source license. You should be able to download it from here[http://www.jessrules.com/].
...
If someone wants to help replacing Jess from Besouro without breaking any test, please let me know!)

After you ask for permisson and get access to your copy of Jess library, you can simply put it
into the 'lib' folder inside Besouro project, and it should compile successfully after a refresh
in Eclipse.

Now, if everything is correctly set up, you must just open the site.xml file inside the besouro_site project
and press the 'build' button. Eclipse will compile everything and put the binaries inside the update site project.
This now is a complete update site you can point your eclipse to (using help -> Install new Software, add the newly 
generated site to the list and follow the wizzard.)
